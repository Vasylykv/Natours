...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiZnlnZXRvaWQiLCJhIjoiY2tudmx3dTZxMG83YjJ2cHNrNTQ0YmtpMCJ9.82XoNyInjEJ5wO6_BClVnA';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/fygetoid/cknvmi22z0ams17t2818dzi1f',
    scrollZoom: false,
    doubleClickZoom: false // center: [-118.113491, 34.111745],
    // zoom: 10,
    // interactive: false,
        ...
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              ...
              window.location.replace('http://127.0.0.1:3000/'); // window.location.reload();
            }
...
/* eslint-disable */
var stripe = Stripe('pk_test_51IlKs9DqzEHZllqhWln0vN6gCAK10JgDnRerUk39IQUSF7zphGcG4qhcT52eeOqJSY0tVJE2MrWBtWqduVM0KFnr001FlTTmDV');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Account is created!');
              window.setTimeout(function () {
                location.assign('/');
              }, 1500);
            }
...
if (signupForm) {
  signupForm.addEventListener('submit', function (e) {
    ...
    var passwordConfirm = signupForm.querySelector('#password-confirm').value;
